...
func can_be_used()-> bool:
	return entity.has_die() != true && is_executing == false	 && not weapon_slot_component.is_attack_ready()
	
func execute(delta:float)->void:
	super(delta)
	entity.weapon_slot_component.prepare_attack(attack_speed_stat.value)
